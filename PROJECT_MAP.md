...
| MV-A | **`dataType` silently ignored** — "Videos Only" / "Both" selections have zero effect; backend always queries `files` (ALPR images) | `routes/manualTransferRoutes.js:16` | **Critical** — misleading UI with no error |
