# Automatic USB Transfer Page

This document outlines the features available on the Automatic USB Transfer page.

## 1. Drive Configuration

The Drive Configuration section allows you to set up the destination for the automatic USB file transfers.
...
-   **Auto Drive Selection**: A dropdown menu to select the target USB drive (e.g., E:, F:, G:) for file transfers.
-   **File Encryption**:
...
1.  **Select a Drive**: Choose a USB drive from the "Auto Drive" dropdown.
...
5.  **Activate Transfer**: Use the "Transfer Active" toggle to start the automatic transfer process.
